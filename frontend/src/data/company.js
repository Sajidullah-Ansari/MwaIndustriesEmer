export const companyInfo = {
  name: "MWA Industries",
  tagline: "Precision Engineering. Heavy Fabrication. Global Standards.",
  description: "MWA Industries is a metal fabrication and heavy engineering company based in Raipur, Chhattisgarh. We specialize in structural steel fabrication, piping, pressure vessels, storage tanks, and precision machining for industrial clients across India.",
  ...
  strengths: [
    {
      ...
      description: "Stringent quality checks at every stage of fabrication",
      icon: "CheckCircle"
    },
    {
      id: "delivery",
      title: "On-Time Delivery",
      description: "Committed to project schedules and deadlines",
      icon: "Clock"
    },
    {
      id: "team",
      title: "Skilled Team",
      description: "Experienced engineers and certified welders",
      icon: "Users"
    },
    {
      id: "precision",
      title: "Precision Machining",
      description: "CNC and conventional machining capabilities",
      icon: "Target"
    },
    {
      id: "safety",
  ...
  about: {
    story: "MWA Industries was established with a vision to provide world-class metal fabrication services to Indian industry. Starting with basic structural fabrication, we have grown to become a comprehensive fabrication facility serving power, steel, cement, oil & gas, and chemical industries. Our journey has been marked by continuous investment in equipment, people, and quality systems.",
